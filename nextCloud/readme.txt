...
# Step 9: 安装 nextCloud
sudo mkdir -p nextCloud && cd nextCloud && wget https://raw.githubusercontent.com/triumph/myk8s/master/nextCloud/docker-compose.yml
sudo vim docker-compose.yml

sudo useradd  -u 65534 -g 65534 nogroup
...
sudo ossfs my-bucket /root/nextCloud/nextcloud/data  -ourl=http://oss-cn-hangzhou-internal.aliyuncs.com -ouid=65534 -ogid=65534 -o allow_other -o umask=007 -o max_stat_cache_size=0


sudo docker-compose up -d
sudo docker-compose stop

sudo fusermount -u /root/nextCloud/nextcloud/data
sudo ossfs my-bucket /root/nextCloud/nextcloud/data  -ourl=http://oss-cn-hangzhou-internal.aliyuncs.com -ouid=65534 -ogid=65534 -o allow_other -o umask=007
